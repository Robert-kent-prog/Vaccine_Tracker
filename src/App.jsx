          ...
          <Router>
            <div className="min-h-screen bg-gray-50">
              <Routes>
                ...
                <Route
                  path="/mother/vaccination-schedule"
                  element={
                    <AuthGuard requiredRole="mother">
                      <MotherLayout>
                ...
                />
                <Route
                  path="/health-worker/record-vaccination"
                  element={
                    <AuthGuard requiredRole="health-worker">
                      <CHWLayout>
                        <RecordVaccination />
                ...
                />
                <Route
                  path="/health-worker/assigned-mothers"
                  element={
                    <AuthGuard requiredRole="health-worker">
                      <CHWLayout>
                        <AssignedMothers />
                ...
                />
                <Route
                  path="/health-worker/defaulters-list"
                  element={
                    <AuthGuard requiredRole="health-worker">
                      <CHWLayout>
                        <DefaultersList />
                ...
                />
                <Route
                  path="/health-worker/field-reports"
                  element={
                    <AuthGuard requiredRole="health-worker">
                      <CHWLayout>
                        <FieldReports />
                ...
                <Route
                  path="/hospital/coverage-reports"
                  element={
                    <AuthGuard requiredRole="hospital">
                      <HospitalLayout>
                        <CoverageReports />
                ...
                <Route
                  path="/hospital/facility-management"
                  element={
                    <AuthGuard requiredRole="hospital">
                      <HospitalLayout>
                        <FacilityManagement />
