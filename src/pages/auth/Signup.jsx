...
const SignUp = () => {
  ...
  const validateStep2 = () => {
    if (selectedRoleData?.showDetails) {
      ...
      if (!formData.location?.trim()) newErrors.location = 'Specific location/village is required'
  ...
  const getStepLabel = (stepNum) => {
    ...
    if (stepNum === 2) return selectedRoleData?.showDetails ? 'Details' : 'Review'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${
                          errors.subCounty ? "border-red-300 bg-red-50" : "border-gray-300"
                        }`}
                      >
                      ...
                      {errors.subCounty && (
                        <p className="text-sm text-red-600 mt-1">{errors.subCounty}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <option value="">
                          {formData.subCounty ? "Select Ward" : "First select Sub-County"}
                        </option>
                        {formData.subCounty &&
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm text-gray-900">{selectedRoleData?.title}</span>
                    </div>
                    <div className="flex justify-between">
